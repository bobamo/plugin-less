...
LessPlugin.prototype.filters = function () {
    this.app.get(this.baseUrl+'*', function(req, res,next){
        this._currentChecksum = null;
        var bootStrapCheck = /bootstrap.min.js/;
        if (this.plugins.generator){
            var origStyles = this.plugins.generator.styles;

            this.generator.__defineGetter__('styles', function(){
                if (this._currentChecksum != null){
                    return ['less/'+this._currentChecksum].concat(_u.filter(origStyles, function(v,i){
                        return bootStrapCheck.test(v);
                    }));
                }
            });
        }
    ...
    this.app.get(this.baseUrl + '*', function (req, res, next) {
            this.local(res, 'lessFactory', this.lessFactory);
        next();
    }.bind(this));
